 ...
 * returns them as double[][], where the first index represents the set of
 * training data and the second index represents which part of that data.
 * 
 * @author OdinhengeT
 * @see Mnist
...
public class MnistFileReader {
	...
	/**
	 * Returns the data in the file as a double[][] where the first index
	 * corresponds to which "item" it is and the second index corresponds to which
	 * instance of data it is in that item. NOTE: Can only be called once, and then
